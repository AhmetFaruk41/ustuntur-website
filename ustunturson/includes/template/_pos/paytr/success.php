...
///////////////////////////////////////////** Sepetteki Ürünleri Veritabanına Aktar *//////////////////////////////////////////
    ...
    ///////////////////////////////////////////** Siparişteki Ürünlerin Adet Eksiltmesi *//////////////////////////////////////////
    if(isset($_SESSION["shopping_cart"]) && count($_SESSION["shopping_cart"])> 0) {

        foreach($_SESSION["shopping_cart"] as $urunsler) {

            $urun_idesi = $urunsler['item_id'];
            $urun_adetinedir = $urunsler['item_quantity'];

            $adet_dusur = $db->prepare("UPDATE urun SET stok = stok-$urun_adetinedir WHERE id='$urun_idesi'  ");
            $adet_dusur->execute();
    ...
    ///////////////////////////////////////////** Siparişteki Ürünlerin Adet Eksiltmesi END *///////////////////////////////////////////
...
//////////////////////////////////////////** E-Posta Bildirimi Açık *//////////////////////////////////////////
	...
	<div style='background-color:#FFF; width:420px; height:auto; border:2px solid #50E3C2;  margin:0px auto;'>
		...
		<div style='width:100%; height:auto; overflow:hidden; margin-top:17px; margin-bottom:17px;'>
			...
			<div style='margin-left:20px; width:88%; font-size:13px; color:#595959; margin-bottom:8px;'>
			Toplam Tutar : <b>".number_format($_SESSION['toplam_odenecek_tutar'], 2)." TL</b>
			</div>					
		    <div style='margin-left:20px; width:88%; font-size:13px; color:#595959; margin-bottom:8px;'>
  ...
  <div style='width:100%; background-color:#F6F4F5; padding-top:35px; padding-bottom:35px;'>
	<div style='background-color:#FFF; width:420px; height:auto; border:2px solid #50E3C2;  margin:0px auto;'>
		...
		<div style='width:100%; height:auto; overflow:hidden; margin-top:17px; margin-bottom:17px;'>
			...
			<div style='margin-left:20px; width:88%; font-size:13px; color:#595959; margin-bottom:8px;'>
			Kartınızdan Çekilen Tutar : <b>".number_format($_SESSION['toplam_odenecek_tutar'], 2)." TL</b>
			</div>					
		</div>
	    <div style='width:100%; height:auto; overflow:hidden; margin-bottom:25px;'>
			<div style='margin-left:20px; width:88%; font-size:13px; color:#8C8C8C; '>
   			 ...
   			 <order>
   	    		 ...
   	    		 <message>
   	        		 ...
   	        		 <receipents>
   	    		 	 ...
   	    		 	 <message>
   	        		 <text>Sayın $musteriname $musterisurname siparişiniz alınmıştır. Sipariş numaranız : $musterisiparisno .En kısa sürede siparişinizin durumuyla ilgili bilgi verilecektir. Bizi tercih ettiğiniz için teşekkür ederiz. $site_adi</text>
   	        		 <receipents>
...
<mp><msg><![CDATA[Sayın '.$musteriname.' '.$musterisurname.' siparişiniz alınmıştır. Sipariş numaranız : '.$musterisiparisno.' .En kısa sürede siparişinizin durumuyla ilgili bilgi verilecektir. Bizi tercih ettiğiniz için teşekkür ederiz. '.$site_adi.' ]]></msg><no>'.$musteritelno.'</no></mp>
</body>
</mainbody>';
        ...
        $postData = "". "<sms>".
            ...
            "<mb><no>$musteritelno</no><msg><![CDATA[Sayın $musteriname $musterisurname siparişiniz alınmıştır. Sipariş numaranız : $musterisiparisno .En kısa sürede siparişinizin durumuyla ilgili bilgi verilecektir. Bizi tercih ettiğiniz için teşekkür ederiz. $site_adi]]></msg></mb>".
            "</messages>".
            "</sms>";
