    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <video src="site-min.mp4" style="height: 100%; width: 100%; object-fit: cover;" autoplay playsinline muted loop></video>
                    <!-- Mavi indigo overlay -->
                    <div style="background: linear-gradient(135deg, rgba(58,50,150,0.55) 0%, rgba(30,42,74,0.65) 100%); width: 100%; height: 100%; position: absolute; top:0; left:0;"></div>
                    <div class="options-slider-box" style="width: 100%; height: 100%; position: absolute; top:0; left:0; display: grid; text-align: center; align-content: center; justify-items: center; padding: 0 2em;">
                        <div class="slider-text-div" style="max-width: 800px;">
                            <div class="slider-section slider-font-type-baslik" style="color:#fff; text-shadow: 0 2px 16px rgba(0,0,0,.4);" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                                <?php echo htmlspecialchars($ayar['site_slogan'] ?? 'Profesyonel Servis Taşımacılığı'); ?>
                            </div>
                            <div class="slider-section slider-font-type-spot" style="color:#fff; opacity:.95;" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1200">
                                20 yıllık tecrübemizle güvenli ve konforlu ulaşım
                            </div>
                            <div class="slider-section" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1400">
                                <a href="iletisim" class="ut-cta-btn">
                                    Teklif Al <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                </a>
                                <a href="hizmetler" class="ut-cta-btn ut-cta-btn-outline">
                                    Hizmetlerimiz
                                </a>
                            </div>
                        </div>
