                ...
                <div class="comment-box" >
                    <div class="comments-box-inside">
                        ...
                        <div class="comments-box-img">
                            <?php
                            $imgPath = $yorum['gorsel'] ?? '';
                            $hasImg  = $imgPath && $imgPath !== 'no-image' && file_exists(__DIR__ . '/../../../images/comments/' . $imgPath);
                            if ($hasImg) { ?>
                                <img src="images/comments/<?php echo $imgPath ?>" alt="<?php echo $yorum['isim'] ?>">
                            <?php } else {
                                $initial = mb_substr(trim($yorum['isim'] ?? '?'), 0, 1, 'UTF-8');
                            ?>
                                <span class="ut-avatar"><?php echo htmlspecialchars(mb_strtoupper($initial, 'UTF-8')); ?></span>
                            <?php }?>
                        </div>
