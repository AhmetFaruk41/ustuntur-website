...
<div class="header-main" style="background-color: #<?=$head['header_menu_bg']?>; ">
        <div class="header-2-main-in">
            ...
            <?php if ($odemeayar['sepet_sistemi'] == 1 || $head['dil_secim'] == 1 ) {?>
            <div class="header-2-actions">
                ...
                <?php if($head['dil_secim'] == 1 ){ ?>
                    <div class="header-2-action-div">
                        <!-- Language Select !-->
                        <div class="dropdown">
                            <button class="btn btn-secondary btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color: #FFF; border:1px solid #<?=$head['dil_border']?>; background-color: #FFF; color:#333; padding: 7px 10px; ">
                                <?php
