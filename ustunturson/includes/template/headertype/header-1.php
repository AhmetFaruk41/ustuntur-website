            ...
            <div class="header-main-right-table">
                <div class="header-main-right-table-ic">
                                                ...
                                                <div class="mega-menu-product-box">
                                                    ...
                                                    <a href="urun/<?=$pops['id']?>/<?=seo($pops['baslik'])?>">
                                                        ...
                                                        <h1 class="font-14 font-bold font-raleway">
                                                            <?php if($pops['fiyat'] ==!null || $pops['fiyat'] == !'0') {?>
                    ...
                    <div class="header-main-menu-div">
                        ...
                        <?php
                        $headersearchdurum = $db->prepare("SELECT * from header_ayar where id='1' and arama_button='1'");
                        $headersearchdurum->execute();
                        while($h = $headersearchdurum->fetch(PDO::FETCH_ASSOC)){
                            ?>
                            ...
                            </div><?php }?><?php if ($odemeayar['sepet_sistemi'] == 1) {?><div class="header-main-menu-other-div">
                        ...
                        $headerdildurum = $db->prepare("SELECT * from header_ayar where id='1' and dil_secim='1'");
                        $headerdildurum->execute();
                        while($h = $headerdildurum->fetch(PDO::FETCH_ASSOC)){
