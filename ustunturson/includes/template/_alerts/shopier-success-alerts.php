...
if ($shopier->verifyShopierSignature($_POST) && isset($_SESSION["shopping_cart"]) && count($_SESSION["shopping_cart"])> 0)  // eğer shopierin hash ile sisteminizdeki hash verify ise bu alan sadece 2 taraflı güvenlik içindir.
{
    ...
    $status = $_POST['status'];
?>
<?php include "includes/template/_pos/shopier/success.php";?>
<?php } else {
