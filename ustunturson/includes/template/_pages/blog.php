...
<meta name="description" content="<?php echo"$blogsett[meta_desc]" ?>">
<meta name="keywords" content="<?php echo"$blogsett[tags]" ?>">
<meta name="news_keywords" content="<?php echo"$blogsett[tags]" ?>">
...
<?php
$page_title = 'Blog';
$page_spot  = 'Sektörden haberler ve uzman görüşleri';
$page_crumb = 'Blog';
