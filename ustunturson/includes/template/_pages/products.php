...
<?php
$page_title = 'Filomuz';
$page_spot  = 'Modern ve geniş araç filomuz';
$page_crumb = 'Filomuz';
...
<div class="products-page-main">
        ...
        <?php if ($odemeayar['kargolimit_product'] == 1) {?>
        <?php if($odemeayar['kargo_limit'] == 0 || $odemeayar['kargo_limit'] == null) {} else { ?>
        <!-- Kargo Bedava ===========================================================================
         ===========================!-->
                <style>
                    .kargo-limit-left-div{width: 100%; height: auto; margin: 0 auto; padding: 15px; background: linear-gradient(to right, #<?=$odemeayar['kargolimit_bg_1']?>, #<?=$odemeayar['kargolimit_bg_2']?>); margin-bottom: 50px; }
                </style>
        <div class="kargo-limit-left-div">
            <div class="kargo-limit-left-div-inside font-<?=$odemeayar['kargolimit_font']?>"  style="color:#<?=$odemeayar['kargolimit_text_color']?>">
                    ...
                    <nav aria-label="Page navigation example" style="margin-top: 50px;">
                        <ul class="pagination pagination-sm justify-content-center">
                            ...
                            <li class="page-item active" aria-current="page">
                              ...
                              <a class="page-link" href="urunler?s=<?=$i?>"><?=$i?><span class="sr-only">(current)</span></a>

                                <?php } else { ?>

                              <a class="page-link" href="urunler?s=<?=$i?>&sirala=<?=$_GET['sirala']?>"><?=$i?><span class="sr-only">(current)</span></a>
