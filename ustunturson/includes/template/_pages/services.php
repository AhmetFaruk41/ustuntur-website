...
$page_spot  = 'Personel servisinden VIP transfere geniş hizmet yelpazemiz';
$page_crumb = 'Hizmetlerimiz';
...
<div class="services-page-main">
    ...
    <div class="services-page-text-main">
        ...
        <div class="services-page-content">
            ...
            <?php if($serv['tip'] == 1)
            {
                ...
                <div class="service-icon-1-icon">
                    <i class="fa fa-bandcamp" style="color:#000"></i>
