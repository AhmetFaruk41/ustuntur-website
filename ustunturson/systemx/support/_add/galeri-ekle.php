...
<?php
$siraCek = $db->prepare("select * from galeri_kat where dil='$_SESSION[dil]'");
$siraCek->execute();
?>
<title>Yeni Galeri Ekle | <?=$ayar['site_baslik']?></title>
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="ti-gallery"></i> Yeni Galeri Ekle</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Yeni Galeri Ekle</li>
            </ol>
        </div>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="font-family: 'Open Sans', Arial; padding: 0.25em;">
                ...
                <div class="card-body p-b-0">
                    <h3 class="card-title">Yeni Galeri Ekle <span style="font-size:15px;">( <i class="flag-icon-<?php echo $lang['flag'] ?>" style="width:18px; height:13px; display: inline-block; margin-right: 10px; "></i><?=$lang['baslik']?> Dilinde ) </span></h3>
                ...
                <!-- Tab panes -->
                <form action="support/post/insert/galeri-ekle.php" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-content">
                    ...
                    <div class="form-actions p-l-20 p-b-20">
                        <button type="submit" class="btn btn-success" name="galeriekle">
