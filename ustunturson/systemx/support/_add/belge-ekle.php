...
<title>Yeni Belge Ekle | <?=$ayar['site_baslik']?></title>
<?php
$Siralama = $db->prepare("select * from belge where durum='1' ");
$Siralama->execute();
?>
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="mdi mdi-format-align-left"></i> Yeni Belge Ekle</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Yeni Belge Ekle</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body" style="font-family: 'Open Sans', Arial">
                ...
                <form action="support/post/insert/belge-ekle.php" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">


                    <h3 class="card-title">Yeni Belge Ekle</h3>
                    <hr>
                    <div class="form-body">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-success" name="belgeekle">
