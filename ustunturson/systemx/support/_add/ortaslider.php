...
<?php
$slider = $db->prepare("select * from slider where tur='2' and durum='1'");
$slider->execute();
?>
<title>Orta Slider Ekle | <?=$ayar['site_baslik']?></title>
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="icon-equalizer"></i> Orta Slider Ekle</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Orta Slider Ekle</li>
            </ol>
        </div>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="font-family: 'Open Sans', Arial">
                ...
                <div class="card-body p-b-0">
                    <h4 class="card-title">Orta Slider Ekle <span style="font-size:15px;">( <i class="flag-icon-<?php echo $lang['flag'] ?>" style="width:18px; height:13px; display: inline-block; margin-right: 10px; "></i><?=$lang['baslik']?> Dilinde ) </span></h4>
                ...
                <!-- Tab panes -->
                <form action="support/post/insert/ortaslider-ekle.php" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 ">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <input type="text" class="form-control jscolor" name="slider_2_bg" value="#333333" id="arkaPlan"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1 ">
                                    <div class="form-group">
                                        ...
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="number" class="form-control" id="sirasiSlider" name="sira" value="<?=$slider->rowCount()+1;?>" required min=1 oninput="validity.valid||(value='');">
                                        </div>
                                    </div>
                                </div>
