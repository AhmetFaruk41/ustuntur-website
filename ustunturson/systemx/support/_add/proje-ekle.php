...
?>
    <title>Yeni Proje Ekle | <?=$ayar['site_baslik']?></title>
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor"><i class="mdi mdi-wrench"></i> Yeni Proje Ekle</h4>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body" style="font-family: 'Open Sans', Arial; padding: 0.25em;">
                    ...
                    <div class="card-body p-b-0">
                        <h3 class="card-title">Yeni Proje Ekle <span style="font-size:15px;">( <i class="flag-icon-<?php echo $lang['flag'] ?>" style="width:18px; height:13px; display: inline-block; margin-right: 10px; "></i><?=$lang['baslik']?> Dilinde ) </span></h3>
                        ...
                        <!-- Tab panes -->
                        <form action="support/post/insert/proje-ekle.php" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 p-l-0 ">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <br><br>
                                                    <textarea name="adres" id="adresArea" class="form-control" rows="2"></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 p-l-0 ">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <br><br>
                                                    <small class="form-control-feedback text-purple" style="font-size:13px">İdeal Ebet : 700x500</small>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="start_date" class="form-control" id="datepicker-autoclose" placeholder="yyyy-aa-gg">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="finish_date" class="form-control" id="datepicker-autoclose2" placeholder="yyyy-aa-gg">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text"><i class="icon-calender"></i></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4 ">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="url" id="webSitesi" aria-describedby="basic-addon1" placeholder="http://">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <textarea name="embed" id="proVideo" class="form-control" rows="3"></textarea>
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label style="font-weight: 500" for="proMapss"><i class="fa fa-map-marker"></i> Proje Google Maps Kodu</label><br><br>
                                                <textarea name="maps" id="proMapss" class="form-control" rows="3" ></textarea>
                    ...
                    <div class="form-actions p-l-20 p-b-20">
                        <button type="submit" class="btn btn-success" name="projeekle">
