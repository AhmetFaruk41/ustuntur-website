...
$urunFotoCek = $db ->prepare("select * from urun_galeri where urun_id='$_GET[urun_id]' order by sira asc ");
$urunFotoCek ->execute();
$row = $urunFotoCek->fetch(PDO::FETCH_ASSOC);
