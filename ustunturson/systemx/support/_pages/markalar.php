...
<title>Markalar | <?=$ayar['site_baslik']?></title>
<?php
$Sayfa = @intval($_GET['page']); if(!$Sayfa) $Sayfa = 1;
$Say = $db->query("select * from marka order by sira ASC");
...
$GorunenSayfa = 5;
$ara = $_GET['search'];
$listele_tablo = $db->query("select * from marka where (baslik like '%$ara%') order by sira ASC limit $Goster,$Limit");
$tabloAl = $listele_tablo->fetchAll(PDO::FETCH_ASSOC);

?>
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="fa fa-registered"></i> Markalar</h4>
    </div>
...
<form action="support/post/multi-delete/markalari-sil.php" method="post">
<div class="row">
    ...
    <div class="col-md-12" style="text-align: left" >
        ...
        <a role="button" href="pages.php?sayfa=markaekle" class="btn btn-info m-b-15" style="color:#FFF" ><i class="fa fa-plus-circle"></i> Yeni Marka Ekle</a>

        <a role="button"   href="pages.php?sayfa=markamodul" class="btn btn-dark m-b-15" style="color:#FFF" ><i class="fa fa-cog"></i> Modül Ayarları</a>
    ...
    <div class="col-12">
        <div class="card" >
            <div class="card-body bg-secondary" >
                ...
                <h3 class="card-title m-b-25">Markalar</h3>
                <h6 class="card-subtitle">Bu alanda Markalarnızı görebilirsiniz. Arama yapmak için sayfanın altına gidiniz.</h6>
                ...
                <div class="table-responsive"  >
                    <table class="table table-bordered" style="font-family: 'Open Sans', Arial; margin-bottom: 0 !important;" >
                        ...
                        <tr>
                            ...
                            <th  style="border-top: 0 !important; border-bottom: 0 !important; text-align: center" width="250">GÖRSEL</th>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: 400; text-align: center;">
                                <img src="../images/clients/<?=$row['gorsel']?>" height="40">
                            </td>
                            ...
                            <td class="text-nowrap" style="text-align: center; border-right: 0 !important;">
                                <a  href="pages.php?sayfa=marka&marka_id=<?=$row['id']?>" class="btn btn-sm btn-info" style="color:#FFF"><i class="fa fa-pencil text-inverse"></i> Düzenle </a>
                    ...
                    <?php if($Sayfa > 1){?>
                        ...
                        <li class="page-item"><a class="page-link" href="pages.php?sayfa=markalar&page="><?=$diller['sayfalama-ilk']?></a></li>
                        <li class="page-item"><a class="page-link" href="pages.php?sayfa=markalar&page=<?=$Sayfa - 1?>"><?=$diller['sayfalama-onceki']?></a></li>
                    ...
                    for($i = $Sayfa - $GorunenSayfa; $i < $Sayfa + $GorunenSayfa +1; $i++){ if($i > 0 and $i <= $Sayfa_Sayisi){
                        if($i == $Sayfa){
                            ...
                            <li class="page-item active" aria-current="page">
                              <a class="page-link" href="pages.php?sayfa=markalar&page='.$i.'">'.$i.'<span class="sr-only">(current)</span></a>
                            </li>
                            ...
                            echo '
                    <li class="page-item"><a class="page-link" href="pages.php?sayfa=markalar&page='.$i.'">'.$i.'</a></li>
                    ';
                        }
                    }
                    }
                    ...
                    <?php if($listele_tablo->rowCount() <=0) { } else { ?>
                        <?php if($Sayfa != $Sayfa_Sayisi){?>
                            ...
                            <li class="page-item"><a class="page-link" href="pages.php?sayfa=markalar&page=<?=$Sayfa + 1?>"><?=$diller['sayfalama-sonraki']?></a></li>
                            <li class="page-item"><a class="page-link" href="pages.php?sayfa=markalar&page=<?=$Sayfa_Sayisi?>"><?=$diller['sayfalama-son']?></a></li>
                ...
                <div class="alert alert-info" style="font-weight: 400">
                  Marka bulunamadı!
                    <?php if(isset($_GET['search'])) {?>
                        <a href="pages.php?sayfa=markalar">Geri Dön</a>
                    <?php }?>
                </div>
                <?php }?>
...
<div class="card p-l-5 p-b-15 p-t-20 bg-secondary">
    ...
    <form method="get" action="pages.php?" >
        <div class="form-row align-items-center">
            ...
            <div class="col-auto">
                <input type="hidden" class="form-control mb-2" id="inlineFormInput" name="sayfa" value="markalar">
            </div>

            <div class="col-auto">
                <input type="text" class="form-control mb-2" id="inlineFormInput" required name="search" placeholder="Marka Adı">
            </div>
...
<script type="text/javascript">
    ...
    function deletebutton(markaid){
        ...
        swal({
            ...
            if (isConfirm) {
                window.location.href = "support/post/delete/marka-sil.php?marka=success&id="+markaid;
            } else {
...
<?php if( $_GET['status']=='success'){ ?>
    ...
    <meta http-equiv="refresh" content="1; URL=pages.php?sayfa=markalar">
<?php }?>
