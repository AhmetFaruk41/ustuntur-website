...
<title>Proje Galerisi | <?=$ayar['site_baslik']?></title>

    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>
<?php
$ListeCekGaleri = $db ->prepare("select * from proje where id='$_GET[proje_id]'");
$ListeCekGaleri ->execute();
$row = $ListeCekGaleri->fetch(PDO::FETCH_ASSOC);

$projeGaleriCek = $db ->prepare("select * from proje_resim where proje_id='$_GET[proje_id]' order by sira asc ");
$projeGaleriCek ->execute();
$foto = $projeGaleriCek->fetch(PDO::FETCH_ASSOC);

$fotolar = $db ->prepare("select * from proje_resim where proje_id='$_GET[proje_id]' order by sira asc ");
$fotolar ->execute();
?>
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="mdi mdi-camera-enhance"></i> Proje Galerisi</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="pages.php?sayfa=proje&proje_id=<?=$row['id']?>"><?=$row['baslik']?></a></li>
                <li class="breadcrumb-item active">Proje Galerisi</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-12" >
        <a role="button"    href="pages.php?sayfa=projeler" class="btn btn-dark m-b-15" style="color:#FFF" ><i class="fa fa-arrow-left"></i> Geri Dön</a>
    </div>
    ...
    <div class="col-12">
        <div class="card" >
            <div class="card-body text-white" style="background: linear-gradient(to right, #4568dc, #b06ab3);" >
                ...
                <h3 class="card-title" style="margin-bottom: 0 !important;"><i class="mdi mdi-camera"></i> <?=$row['baslik']?> Proje Galerisi</h3>
    ...
    <div class="col-12" >
        <div class="card bg-secondary" style=" border-bottom:1px solid #EBEBEB; ">
            <div class="card-body" style="padding: 15px !important; text-align: center;">
                ...
                <form action="support/post/insert/proje-galeri-ekle.php" method="post" enctype='multipart/form-data'>
        ...
        <div class="card">
            <div class="card-body" style="padding: 15px !important; ">
                        ...
                        <tr  id="<?=$galeri['id']?>">
                            ...
                            <td style="cursor: all-scroll">
                                <div id="<?=$galeri['id']?>" class="degisken" style="margin: 10px; display: inline-block !important;">
                                    ...
                                    <img src="../images/projects/<?=$galeri['gorsel']?>" style="width: 185px; height: 130px; border:1px solid #EBEBEB">
                                </div>
                            </td>
                        </tr>
                    <?php } ?>
                ...
                <div class="alert alert-danger text-center" style="font-weight: 400; margin-top: 15px;">
                   <?=$row['baslik']?> Projesine Hiç Fotoğraf Eklenmemiş!
                </div>
                <?php }?>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function updateOrder(data) {
            $.ajax({
                url:"support/post/update/proje-galeri-siralama.php",
                type:'post',
                data:{position:data},
                success:function(){
...
<script type="text/javascript">
    ...
    function deletebutton(fotoid,projeid){
        ...
        swal({
            ...
            if (isConfirm) {
                window.location.href = "support/post/delete/proje-galeri-sil.php?proje=success&id="+fotoid+"&proje_id="+projeid;
            } else {
...
<?php if( $_GET['status']=='success'){ ?>
    ...
    <meta http-equiv="refresh" content="1; URL=pages.php?sayfa=projegaleri&proje_id=<?=$_GET['proje_id']?>">
<?php }?>
