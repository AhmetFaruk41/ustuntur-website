...
if ($adminsorgusu->rowCount()===0) {
    ...
    if (isset($_POST['sil'])) {
        ...
        $sorgu = $db->prepare('DELETE FROM `pricing_ozellik` WHERE `id` IN (' . $silinecekler . ')');
        $sorgu->execute();
        ...
        Header("location: ../../../pages.php?sayfa=pricingozellikleri&pricing_id=$_POST[pricing_id]&status=nocheck");
    }
}
?>