    ...
    if (isset($_POST['ekipdegis'])) {
        ...
        if ($_FILES['gorsel']["size"] > 0) {
            ...
            if ($dosyas['type'] == 'image/jpg' || $dosyas['type'] == 'image/jpeg' || $dosyas['type'] == 'image/png') {
                ...
                $kaydet = $db->prepare("UPDATE ekip SET
            durum=:durum,
            isim=:isim,
            sira=:sira,
            mail=:mail,
        ...
        ");
                ...
                if ($ekle) {
                    ...
                    unlink("../../../../images/team/$gorseladres");
                ...
                Header("location: ../../../pages.php?sayfa=ekip&ekip_id=$_POST[ekip_id]&status=imgtype");
            }
