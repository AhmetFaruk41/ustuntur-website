...
if ($adminsorgusu->rowCount()===0) {
    ...
    if (isset($_POST['galeridegis'])) {
        ...
        if ($_FILES['gorsel']["size"] > 0) {
            ...
            $hedef = "../../../../images/gallery/" . $yeni_isim;
            ...
            if ($dosyas['type'] == 'image/jpg' || $dosyas['type'] == 'image/jpeg' || $dosyas['type'] == 'image/png') {
                ...
                $kaydet = $db->prepare("UPDATE galeri_kat SET
            durum=:durum,
            sira=:sira,
            baslik=:baslik,
            anasayfa=:anasayfa,
        ...
        ");
                ...
                if ($ekle) {
                    ...
                    unlink("../../../../images/gallery/$resimsilunlink");
                    Header("location: ../../../pages.php?sayfa=galeriler&status=success");

                } else {

                    Header("location: ../../../pages.php?sayfa=galeriler&status=warning");

                }

            } else {
                Header("location: ../../../pages.php?sayfa=galeri&galeri_id=$_POST[galeri_id]&status=imgtype");
            }
