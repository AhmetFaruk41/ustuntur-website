    ...
    if (isset($_POST['markadegis'])) {
        ...
        if ($_FILES['gorsel']["size"] > 0) {
            ...
            if ($dosyas['type'] == 'image/jpg' || $dosyas['type'] == 'image/jpeg' || $dosyas['type'] == 'image/png') {
                ...
                $kaydet = $db->prepare("UPDATE marka SET
            durum=:durum,
            baslik=:baslik,
            sira=:sira,
            url=:url,
            gorsel=:gorsel
            WHERE id={$_POST[marka_id]}
        ");
                ...
                if ($ekle) {
                    ...
                    unlink("../../../../images/clients/$resimsilunlink");
                ...
                Header("location: ../../../pages.php?sayfa=marka&marka_id=$_POST[marka_id]&status=imgtype");
            }
