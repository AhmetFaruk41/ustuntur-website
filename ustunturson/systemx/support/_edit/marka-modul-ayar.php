...
<?php
$modulAyar = $db->prepare("select * from marka_ayar where id='1'");
$modulAyar->execute();
$row = $modulAyar->fetch(PDO::FETCH_ASSOC);
?>

<title>Markalar Modül Ayarları | <?=$ayar['site_baslik']?></title>
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="fa fa-registered"></i> Markalar Modül Ayarları</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Markalar Modül Ayarları</li>
            </ol>
        </div>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="font-family: 'Open Sans', Arial">
                ...
                <div class="card-body p-b-0">
                    <h4 class="card-title">Markalar Modül Ayarları</h4>
                    <h6 class="card-subtitle">Markalar Modül Ayarları genel olarak anasayfadaki ürün modülünün görünüm ayarlarını içermektedir</h6> </div>
                ...
                <!-- Tab panes -->
                <form action="support/post/update/marka-modul-ayar.php" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="genel" role="tabpanel">
                        <div class="p-20">
                            ...
                            <div class="row" style="margin-bottom: 25px;  ">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <br><br>
                                        <small class="text-success" style="font-size:13px">Bu yazıyı dil ayarlarınızdaki düzenleme alanının <strong>48.satırından</strong> değiştirebilirsiniz</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="text" class="form-control" disabled value="<?=$diller['marka']?>" id="modulBaslik">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <br><br>
                                        <small class="text-success" style="font-size:13px">Bu yazıyı dil ayarlarınızdaki düzenleme alanının <strong>49.satırından</strong> değiştirebilirsiniz</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <textarea  id="modulSpot" rows="1" class="form-control" disabled><?=$diller['marka-aciklamasi']?></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row" style="margin-bottom: 25px;  ">
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        <label style="font-weight: 500" for="yorumLimit">Marka Sayısı (Anasayfa)</label>
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Anasayfa markalar modülünüzdeki listelenecek marka sayısı</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="number" class="form-control " name="marka_limit" value="<?=$row['marka_limit']?>" id="yorumLimit" required min=1 oninput="validity.valid||(value='');">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane p-20" id="meta" role="tabpanel">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <small class="text-purple" style="font-size:13px;">Sadece <strong>markalar</strong> sayfası için geçerlidir. </small>
                                <br><br>
                    ...
                    <div class="form-actions p-l-20">
                        <button type="submit" class="btn btn-success" name="markamoduldegis">
...
<?php if( $_GET['status']=='success'){ ?>
    ...
    <meta http-equiv="refresh" content="2; URL=pages.php?sayfa=markamodul">
<?php }?>
