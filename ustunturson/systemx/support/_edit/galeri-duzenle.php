...
<?php
$degerCek = $db->prepare("select * from galeri_kat where dil='$_SESSION[dil]' and id='$_GET[galeri_id]'");
$degerCek->execute();
...
?>
<title>Galeri Düzenle | <?=$ayar['site_baslik']?></title>
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="ti-gallery"></i> Galeri Düzenle</h4>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="font-family: 'Open Sans', Arial; padding: 0.25em;">
                ...
                <div class="card-body p-b-0">
                    <h3 class="card-title">Galeri Düzenle <span style="font-size:15px;">( <i class="flag-icon-<?php echo $lang['flag'] ?>" style="width:18px; height:13px; display: inline-block; margin-right: 10px; "></i><?=$lang['baslik']?> Dilinde ) </span></h3>
                ...
                <!-- Tab panes -->
                <form action="support/post/update/galeri-duzenle.php" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-content">
                            ...
                            <div class="row">
                                <div class="col-md-12 p-l-0 ">
                                    <div class="form-group col-md-12">
                                        <label style="font-weight: 500" for="ustKat"><i class="fa fa-photo"></i> Galeri Kapak Görseli</label>
                                        <div style="width: 100%; height: auto; background-color: #F9F9F9; border:1px solid #EBEBEB; padding: 15px; 0 15px 0; text-align: center;  margin-top:8px;">
                                            <img src="../images/gallery/<?=$row['gorsel']?>" style="width: 250px; ">
                    ...
                    <div class="form-actions p-l-20 p-b-20">
                        <button type="submit" class="btn btn-success" name="galeridegis">
