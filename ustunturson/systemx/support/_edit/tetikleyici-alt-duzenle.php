...
<?php
$veriCek = $db->prepare("select * from tetikleyiciler where id='$_GET[id]' and dil='$_SESSION[dil]' ");
$veriCek->execute();
...
?>
    <title>Alt Tetikleyici Düzenle | <?=$ayar['site_baslik']?></title>
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor"><i class="mdi mdi-needle"></i> Alt Tetikleyici Düzenle</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Alt Tetikleyici Düzenle</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body" style="font-family: 'Open Sans', Arial; padding: 0.25em;">
                    ...
                    <div class="card-body p-b-0">
                        <h3 class="card-title">Alt Tetikleyici Düzenle<span style="font-size:15px;">( <i class="flag-icon-<?php echo $lang['flag'] ?>" style="width:18px; height:13px; display: inline-block; margin-right: 10px; "></i><?=$lang['baslik']?> Dilinde ) </span></h3>
                        ...
                        <!-- Tab panes -->
                        <form action="support/post/update/tetikleyici-alt-duzenle.php" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group" >
                                                        <input type="text" name="text" class="form-control" id="txT" required placeholder="ÖRN : Detaylı Bilgi İçin Bizi Arayın" value="<?=$row['text']?>">
                                                    </div>
                                                </div>
                                            </div>
