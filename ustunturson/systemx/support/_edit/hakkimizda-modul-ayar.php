...
<?php
$modulAyar = $db->prepare("select * from about_ayar where id='1'");
$modulAyar->execute();
$row = $modulAyar->fetch(PDO::FETCH_ASSOC);
?>

<title>Hakkımızda Sayfası Modül Ayarları | <?=$ayar['site_baslik']?></title>
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="ti-files"></i> Hakkımızda Sayfası Modül Ayarları</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Hakkımızda Sayfası Modül Ayarları</li>
            </ol>
        </div>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="font-family: 'Open Sans', Arial">
                ...
                <div class="card-body p-b-0">
                    <h4 class="card-title">Hakkımızda Sayfası Modül Ayarları</h4>
                    <h6 class="card-subtitle">Hakkımızda Sayfası Modül Ayarları genel olarak anasayfadaki ürün modülünün görünüm ayarlarını içermektedir</h6> </div>
                ...
                <!-- Tab panes -->
                <form action="support/post/update/hakkimizda-modul-ayar.php" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="genel" role="tabpanel">
                        <div class="p-20 p-b-0">
                            ...
                            <div class="row" style="margin-bottom: 25px;  ">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label style="font-weight: 500" for="modulBaslik">Modül Devamı Button Yazısı</label>
                                        <br><br>
                                        <small class="text-success" style="font-size:13px">Bu yazıyı dil ayarlarınızdaki düzenleme alanının <strong>207.satırından</strong> değiştirebilirsiniz</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="text" class="form-control" disabled value="<?=$diller['modul-hakkimizda-devami']?>" id="modulBaslik">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label style="font-weight: 500" for="modulBaslik">Footer Devamı Button Yazısı</label>
                                        <br><br>
                                        <small class="text-success" style="font-size:13px">Bu yazıyı dil ayarlarınızdaki düzenleme alanının <strong>50.satırından</strong> değiştirebilirsiniz</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="text" class="form-control" disabled value="<?=$diller['footer-hakkimizda-devami']?>" id="modulBaslik">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row" style="margin-bottom: 25px;  ">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label style="font-weight: 500" for="spotColor">Yazıların Rengi</label>
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Modüldeki hakkımızda kısa açıklamasının rengi</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="text" class="form-control jscolor" name="text_color" value="<?=$row['text_color']?>" id="spotColor">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Devamı butonunun arkaplan rengini seçebilirsiniz</small>
                                        <br><br>
                                        <div class="input-group" >
                    ...
                    <div class="tab-pane p-20 p-b-0" id="meta" role="tabpanel">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <small class="text-purple" style="font-size:13px;">Sadece <strong>hakkımızda</strong> sayfası için geçerlidir. </small>
                                <br><br>
                    ...
                    <div class="form-actions p-l-20">
                        <button type="submit" class="btn btn-success" name="hakkimizdamoduldegis">
...
<?php if( $_GET['status']=='success'){ ?>
    ...
    <meta http-equiv="refresh" content="1; URL=pages.php?sayfa=hakkimizdamodul">
<?php }?>
