...
<?php
$modulAyar = $db->prepare("select * from video_ayar where id='1'");
$modulAyar->execute();
$row = $modulAyar->fetch(PDO::FETCH_ASSOC);
?>

<title>Video Modül Ayarları | <?=$ayar['site_baslik']?></title>
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="mdi mdi-youtube-play"></i> Video Modül Ayarları</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Video Modül Ayarları</li>
            </ol>
        </div>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="font-family: 'Open Sans', Arial">
                ...
                <div class="card-body p-b-0">
                    <h4 class="card-title">Video Modül Ayarları</h4>
                    <h6 class="card-subtitle">Video Modül Ayarları genel olarak anasayfadaki ürün modülünün görünüm ayarlarını içermektedir</h6> </div>
                ...
                <!-- Tab panes -->
                <form action="support/post/update/video-modul-ayar.php" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="genel" role="tabpanel">
                        <div class="p-20">
                            ...
                            <div class="row" style="margin-bottom: 25px;  ">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <br><br>
                                        <small class="text-success" style="font-size:13px">Bu yazıyı dil ayarlarınızdaki düzenleme alanının <strong>54.satırından</strong> değiştirebilirsiniz</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="text" class="form-control" disabled value="<?=$diller['video']?>" id="modulBaslik">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <br><br>
                                        <small class="text-success" style="font-size:13px">Bu yazıyı dil ayarlarınızdaki düzenleme alanının <strong>55.satırından</strong> değiştirebilirsiniz</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <textarea  id="modulSpot" rows="1" class="form-control" disabled><?=$diller['video-aciklamasi']?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label style="font-weight: 500" for="modulBaslik">Buton Yazısı</label>
                                        <br><br>
                                        <small class="text-success" style="font-size:13px"><strong>56.satırından</strong> değiştirebilirsiniz</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="text" class="form-control" disabled value="<?=$diller['videoyu-izle']?>" id="modulBaslik">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row" style="margin-bottom: 25px;  ">
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        <label style="font-weight: 500" for="videoLimit">Video Sayısı Limiti (Anasayfa)</label>
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Anasayfa video modülünüzdeki listelenecek video sayısı</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="number" class="form-control " name="video_limit" value="<?=$row['video_limit']?>" id="videoLimit" required min=1 oninput="validity.valid||(value='');">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Videoyu izle yazısının olduğu butonun arkaplan rengini seçebilirsiniz</small>
                                        <br><br>
                                        <div class="input-group" >
                    ...
                    <div class="tab-pane p-20" id="meta" role="tabpanel">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <small class="text-purple" style="font-size:13px;">Sadece <strong>videolar</strong> sayfası için geçerlidir. Video detay sayfalarının meta ayarları yeni video ekleme sayfasından eklenmelidir</small>
                                <br><br>
                    ...
                    <div class="form-actions p-l-20">
                        <button type="submit" class="btn btn-success" name="videomoduldegis">
...
<?php if( $_GET['status']=='success'){ ?>
    ...
    <meta http-equiv="refresh" content="2; URL=pages.php?sayfa=videomodul">
<?php }?>
