...
<?php
$modulAyar = $db->prepare("select * from hizmet_ayar where id='1'");
$modulAyar->execute();
$row = $modulAyar->fetch(PDO::FETCH_ASSOC);
?>

<title>Hizmet Modül Ayarları | <?=$ayar['site_baslik']?></title>
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="ti-dropbox"></i> Hizmet Modül Ayarları</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Hizmet Modül Ayarları</li>
            </ol>
        </div>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="font-family: 'Open Sans', Arial">
                ...
                <div class="card-body p-b-0">
                    <h4 class="card-title">Hizmet Modül Ayarları</h4>
                    <h6 class="card-subtitle">Hizmet Modül Ayarları genel olarak anasayfadaki ürün modülünün görünüm ayarlarını içermektedir</h6> </div>
                ...
                <!-- Tab panes -->
                <form action="support/post/update/hizmet-modul-ayar.php" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="genel" role="tabpanel">
                        <div class="p-20">
                            ...
                            <div class="row" style="margin-bottom: 25px;  ">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <br><br>
                                        <small class="text-success" style="font-size:13px">Bu yazıyı dil ayarlarınızdaki düzenleme alanının <strong>17.satırından</strong> değiştirebilirsiniz</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="text" class="form-control" disabled value="<?=$diller['hizmetlerimiz']?>" id="modulBaslik">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <br><br>
                                        <small class="text-success" style="font-size:13px">Bu yazıyı dil ayarlarınızdaki düzenleme alanının <strong>18.satırından</strong> değiştirebilirsiniz</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <textarea  id="modulSpot" rows="1" class="form-control" disabled><?=$diller['hizmetlerimiz-aciklamasi']?></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row" style="margin-bottom: 25px;  ">
                                ...
                                <div class="col-md-2 ">
                                    <div class="form-group">
                                        <label style="font-weight: 500" for="tipitip">Hizmetler Modül Tipi</label>
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Anasayfa ve hizmetler sayfasındaki görünümü ilgilendirir</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <select name="tip" id="tipitip" class="form-control">
                                                <option value="0" <?php if ($row['tip'] == 0) { ?>selected <?php }?> > Resimli Hizmetler</option>
                                                <option value="1" <?php if ($row['tip'] == 1) { ?>selected <?php }?>>İkonlu Hizmetler - 1</option>
                                                <option value="2" <?php if ($row['tip'] == 2) { ?>selected <?php }?>>İkonlu Hizmetler - 2</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2 ">
                                    <div class="form-group">
                                        <label style="font-weight: 500" for="İnceleTextt">İkon Renkleri</label>
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Hizmet tipi ikon 1 veya ikon 2 ise geçerlidir</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="text" class="form-control jscolor" name="icon_color" value="<?=$row['icon_color']?>" id="İnceleTextt">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2 ">
                                    <div class="form-group">
                                        <label style="font-weight: 500" for="hizmetTextColur">Hizmet Yazı Rengi</label>
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Anasayfadaki hizmetlerin başlık ve içerik yazı rengi</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="text" class="form-control jscolor" name="hizmet_color" value="<?=$row['hizmet_color']?>" id="hizmetTextColur">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2 ">
                                    <div class="form-group">
                                        <label style="font-weight: 500" for="hizmetLimit">Hizmet Listeleme Limiti</label>
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Anasayfadaki hizmetler modülünün listelenme limiti</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="number" class="form-control" name="hizmet_limit" value="<?=$row['hizmet_limit']?>" id="hizmetLimit">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2 ">
                                    <div class="form-group">
                                        <label style="font-weight: 500" for="detayUrl">Hizmet Detay Gösterimi</label>
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Pasif bırakırsanız hizmetlerin detay sayfalarına erişilemez</small>
                                        <br><br>
                                        <div class="input-group" >
                            ...
                            <h4 style="font-weight: 500"><i class="mdi mdi-palette"></i> Hizmet Detay Menü Ayarı</h4>
                            ...
                            <div class="row" >
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label style="font-weight: 500" for="menuBg">Hizmet Detay Menü Arkaplanı</label>
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Hizmet detaylarında sağ taraftaki hizmet başlıklarının arkaplanı</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="text" class="form-control jscolor" name="detay_button_bg" value="<?=$row['detay_button_bg']?>" id="menuBg">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label style="font-weight: 500" for="menuTrxtColor">Hizmet Detay Başlık Yazı Rengi</label>
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Hizmet detaylarındaki sağ taraftaki hizmet başlıklarının yazı rengi</small>
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="text" class="form-control jscolor" name="detay_button_color" value="<?=$row['detay_button_color']?>" id="menuTrxtColor">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane p-20" id="meta" role="tabpanel">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <small class="text-purple" style="font-size:13px;">Sadece <strong>hizmetlerimiz</strong> sayfası için geçerlidir. Hizmet detay sayfalarının meta ayarları yeni hizmet ekleme sayfasından eklenmelidir</small>
                                <br><br>
                    ...
                    <div class="form-actions p-l-20">
                        <button type="submit" class="btn btn-success" name="hizmetmoduldegis">
...
<?php if( $_GET['status']=='success'){ ?>
    ...
    <meta http-equiv="refresh" content="2; URL=pages.php?sayfa=hizmetmodul">
<?php }?>
