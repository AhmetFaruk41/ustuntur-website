                    ...
                    <div class="tab-pane active" id="head" role="tabpanel">
                        <div class="p-20">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        <label style="font-weight: 500">Header Modül Tip Seçimi</label>
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Tip 2 için en alttan renk ayarlarını yapabilirsiniz</small>
                                        <br><br>
                                        <div class="input-group" >

                                            <select name="header_tip" class="form-control" >
                                                <option value="1" <?php if($head['header_tip'] == 1 ) { ?> selected <?php }?>>Header - Tip 1</option>
                                                <option value="2" <?php if($head['header_tip'] == 2 ) { ?> selected <?php }?>>Header - Tip 2</option>
                                            </select>
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <br><br>
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Kalıklık değerleri sırasıyla 300,500,600 ve 700'dür.</small>
                                        <br>  <br>
                                        <div class="input-group" >
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <small class="form-control-feedback text-purple" style="font-size:13px">İdeal : <span style="font-weight: 500">13px</span></small>
                            ...
                            <div class="row m-b-40">
                                ...
                                <div class="col-md-4 ">
                                    <div class="form-group">
                                        ...
                                        <small class="form-control-feedback text-purple" style="font-size:13px">Header menünüzün kaç tane görünmesini istiyorsanız kutuya girin</small>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <label style="font-weight: 500" for="headBgs">Header Alanı Arkaplan Rengi [ Header 1 ve 2 İçin]</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <label style="font-weight: 500" for="bgColorHover">Menu Kutusu Arkaplan Hover Rengi [ Header 1,2 ve Mobil İçin ]</label>
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <label style="font-weight: 500" for="textColors">Menu Yazı Rengi [ Header 1,2 ve Mobil İçin ]</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <label style="font-weight: 500" for="textHoverColors">Menu Yazı Hover Rengi [ Header 1,2 ve Mobil İçin ]</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            <label style="font-weight: 500" ><i class="fa fa-shopping-cart" style="font-size:20px; float:left; margin-right: 10px"></i> Sepet İkonu Ayarları </label>
                                            <br><br>
                                            <div class="alert alert-warning" style="font-weight: 500">
                                                HEADER 1 için Sepet ikonu renk ayarlarını <strong>Ticaret Ayarları > Ticari Ayarlar</strong> alanından yapabilirsiniz. Ayrıca sepet ikonunu değiştirebilir, sepet sistemini de dilerseniz devre dışı bırakabilirsiniz.
                                            </div>
                                            <div class="alert alert-info" style="font-weight: 500">
                                                HEADER 2 Sepet görünüm ayarı için <strong>aşağıdaki Header Tip 2 Ayarlarını</strong> kullanın
                                            </div>
                                            <div class="alert alert-dark" style="font-weight: 500">
                                                NOT : Sepet ürün sayısı görünümü için <strong>Ticaret Ayarları > Ticari Ayarlar</strong> alanına gidin
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <h3><i class="mdi mdi-palette"></i> Header Tip 2 Ayarları</h3>
                                <hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="form-group">
                                            <label style="font-weight: 500" for="h2Bg">HEADER-2 Menu Zemin Rengi [Mobil İçinde Geçerli]</label>
                                            <br><br>
                                            <small class="form-control-feedback text-purple" style="font-size:13px">Header Tip 2 için menülerin altındaki zemin rengi. Ayrıca mobil içinde geçerlidir</small>
                                            <br><br>
                                            <div class="input-group" >
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="form-group">
                                            <label style="font-weight: 500" for="bgBorderh2">HEADER-2 Üst Kenarlık Rengi</label>
                                            <br><br>
                                            <small class="form-control-feedback text-purple" style="font-size:13px">Header Tip 2 için menü ile logo arasındaki çizgi rengi</small>
                                            <br><br>
                                            <div class="input-group" >
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="form-group">
                                            <label style="font-weight: 500" for="searchH2bg">HEADER-2 Arama Alanı Kenarlık ve Button Rengi</label>
                                            <br><br>
                                            <small class="form-control-feedback text-purple" style="font-size:13px">Header Tip 2 için arama alanına ait kenarlık ve arama butonu arkaplan rengi</small>
                                            <br><br>
                                            <div class="input-group" >
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label style="font-weight: 500">HEADER-2 Sepet Alanı Arkaplan Rengi</label>
                                            <br><br>
                                    ...
                                    <div class="col-md-3 ">
                                        <div class="form-group">
                                            <label style="font-weight: 500">HEADER-2 Menü Hizası</label>
                                            <br><br>
                                    ...
                                    <div class="col-md-3 ">
                                        <div class="form-group">
                                            <label style="font-weight: 500" for="h2Height">HEADER-2 Yükseklik Değeri</label>
                                            <br><br>
                                    ...
                                    <div class="col-md-3 ">
                                        <div class="form-group">
                                            <label style="font-weight: 500" for="spacePx">HEADER-2 Alt Boşluk Değeri</label>
                                            <br><br>
