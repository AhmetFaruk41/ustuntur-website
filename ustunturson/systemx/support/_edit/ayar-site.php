            ...
            <div class="card-body" style="font-family: 'Open Sans', Arial">
                ...
                <form action="support/post/update/ayar-site.php" class="form-horizontal form-bordered" method="post">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            <label class="control-label text-right col-md-3" for="siteAdresiURL" style="margin-top: 9px;  margin-bottom: 10px; font-weight: 600"><i class="fa fa-info-circle" data-toggle="tooltip" data-placement="left" title="Site urlnizin sonuna / mutlaka ekleyin"></i> Site URL ( http - https )</label>
                            <div class="col-md-6">
                                <input type="text" id="siteAdresiURL"  class="form-control" required name="site_url" value="<?=$ayar['site_url']?>">
                            </div>
                        </div>

                        <h3 class="box-title m-t-40">SEO - Meta Ayarları</h3>
                        <hr>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="control-label text-right col-md-3" for="siteAdresiURL" style="margin-top: 5px;  margin-bottom: 10px; font-weight: 600">Site Etiketleri</label>
                            <div class="col-md-6">
                                <input type="text"  data-role="tagsinput" placeholder="Etiket Ekle" name="site_tags" value="<?=$ayar['site_tags']?>" />
                            </div>
                        </div>
