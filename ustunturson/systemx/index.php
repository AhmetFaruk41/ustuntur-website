        ...
        <div class="container-fluid">
            ...
            <div class="row">
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-info">
                                    <p id="onlinever" style="padding: 0px; margin: 0px"></p>
                                    <script>
                                        function veriler2(){ $.get("support/online.php",function(data){ jQuery('#onlinever').html(data); }); }
                                        window.setInterval("veriler2()",3000);
                                    </script></h3>
                                <h5 class="text-muted m-b-0">Online Sayısı</h5></div>
                        </div>
                    </div>
                </div>
                <!-- Column -->
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card">
                        <div class="d-flex flex-row">
                            <div class="p-10 bg-success text-center">
                                <i style="font-size:23px; padding: 0 12px 0 12px" class="icon-people text-white"></i>
                                <br>
                            <span data-toggle="tooltip" data-placement="top" title="Çoğul Hit" style="font-size:14px; font-family: 'Open Sans', Arial; color:#FFF; font-weight: 500; cursor: pointer"><?php echo $bugun_cogul; ?></span>
                            </div>
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-success"><?php echo $bugun_tekil; ?></h3>
                                <h5 class="text-muted m-b-0">Günlük Hit </h5>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card">
                        <div class="d-flex flex-row">
                            <div class="p-10 bg-inverse text-center">
                                <i style="font-size:23px; padding: 0 12px 0 12px" class="icon-people text-white"></i>
                                <br>
                                <span data-toggle="tooltip" data-placement="top" title="Çoğul Hit" style="font-size:14px; font-family: 'Open Sans', Arial; color:#FFF; font-weight: 500; cursor: pointer"><?php echo $buay_cogul; ?></span>
                            </div>
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0"><?php echo $buay_tekil; ?></h3>
                                <h5 class="text-muted m-b-0">Bu Aylık Hit</h5></div>
                        </div>
                    </div>
                </div>
                <!-- Column -->
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card">
                        <div class="d-flex flex-row">
                            <div class="p-10 bg-primary text-center">
                                <i style="font-size:23px; padding: 0 12px 0 12px" class="icon-people text-white"></i>
                                <br>
                                <span data-toggle="tooltip" data-placement="top" title="Çoğul Hit" style="font-size:14px; font-family: 'Open Sans', Arial; color:#FFF; font-weight: 500; cursor: pointer"><?php echo $toplam_cogul; ?></span>
                            </div>
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-primary"><?php echo $toplam_tekil; ?></h3>
                                <h5 class="text-muted m-b-0">Toplam Hit</h5></div>
                        </div>
                    </div>
                </div>
                <!-- Column -->
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card" style="background: linear-gradient(45deg, #f16e3c, #e3c94b) !important;">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <h3><i class="icon-settings text-secondary"></i></h3>
                                            <p class="text-secondary">TOPLAM PROJE</p>
                                        </div>
                                        <div class="ml-auto">
                                            <h2 class="counter text-secondary"><?php echo $projesayisi->rowCount() ?></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex">
                                <div>
                                    <h5 class="card-title">Son Eklenen Hizmetler</h5>
                                </div>
                                <div class="ml-auto">
                                    <a href="pages.php?sayfa=hizmetler">
                                <span class="text-muted pull-right" style="font-size:13px; padding-top: 4px; font-weight: 500">
                                TÜMÜ
                                </span>
                                    </a>
                        ...
                        <div class="card-body bg-light"  <?php  if($servicess->rowCount()<=0) {  ?>style="border-bottom: 1px solid #dee2e6;" <?php }?>>
                            <div class="row">
                                <div class="col-6">
                                    <a href="pages.php?sayfa=hizmetekle" role="button" class="btn btn-success"><i class="mdi mdi-plus"></i> YENİ HİZMET EKLE</a>
                                </div>
                                <div class="col-6 align-self-center display-6 text-right">
                                    <h6 class="text-muted">Sol butondan yeni hizmet ekleyebilirsiniz</h6></div>
                            </div>
                        </div>
                        <div class="table-responsive" <?php if($servicess->rowCount()>4) {?>id="slimtest1" style="margin-bottom: 19px; height: 440px; overflow: hidden"<?php }?>>
                            <?php
                            if($servicess->rowCount()>0) {
                                ?>
                                <table class="table table-hover">
                                    <tbody>
                                    <?php foreach ($servicess as $hizmet) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="txt-oflo">
                                                ...
                                                <span class="action-icons">
                                                    <a href="pages.php?sayfa=hizmet&hizmet_id=<?=$urun['id']?>"><i class="ti-pencil-alt" style="color:red"></i></a>
                                        </span>

                                            </td>
                                            <td>

                                                <?php if($hizmet['durum'] == 1) {?>
                                                    <span class="badge badge-pill badge-info"><i class="fa fa-check"></i> Yayında</span>
                                                <?php } else {?>
                                                    <span class="badge badge-pill badge-danger"><i class="fa fa-times"></i> Yayında Değil</span>
                                                <?php }?>
                ...
                <div class="col-lg-4">
                            ...
                            <div id="myCarousel3" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active flex-column">
                                        <i class="ti-layout-grid2 text-white" style="font-size:24px"></i>
                                        <p class="text-white">Modül Sıralaması</p>
                                        <h3 class="text-white">Modülleri <span class="font-bold">kendinize göre</span> <br>sıralayabilirsiniz</h3>
                                        <div>
                                            <a class="btn btn-dark b-0 waves-effect waves-light m-t-15 text-white" href="pages.php?sayfa=modulsiralama">DETAYLAR</a>
                                        </div>
                                    </div>

                                    <div class="carousel-item flex-column">
                                        <i class="icon-basket text-white" style="font-size:24px"></i>
                                        <p class="text-white">Ticaret Ayarları</p>
                                        <h3 class="text-white">Alışveriş sistemi <span class="font-bold">ayarlarına</span> <br>göz atabilirsiniz</h3>
                                        <div>
                                            <a class="btn btn-dark b-0 waves-effect waves-light m-t-15 text-white" href="pages.php?sayfa=ticariayar">DETAYLAR</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="carousel-item flex-column">
                                        <i class="icon-basket text-white" style="font-size:24px"></i>
                                        <p class="text-white">Ticaret Ayarları</p>
                                        <h3 class="text-white">Sanal POS <span class="font-bold">ayarlarınızı</span> <br>inceleyebilirsiniz</h3>
                                        <div>
                                            <a class="btn btn-dark b-0 waves-effect waves-light m-t-15 text-white" href="pages.php?sayfa=posayar">DETAYLAR</a>
                                        </div>
                                    </div>

                                    <div class="carousel-item flex-column">
                                        <i class="ti-world text-white" style="font-size:24px"></i>
                                        <p class="text-white">Sınırsız Dil</p>
                                        <h3 class="text-white">Dilediğiniz kadar <span class="font-bold">dil</span> <br>ekleyebilirsiniz</h3>
                                        <div>
                                            <a class="btn btn-dark b-0 waves-effect waves-light m-t-15 text-white" href="pages.php?sayfa=diller">DETAYLAR</a>
                                        </div>
                                    </div>

                                    <div class="carousel-item flex-column">
                                        <i class="ti-pin-alt text-white" style="font-size:24px"></i>
                                        <p class="text-white">Sayfa Bannerları</p>
                                        <h3 class="text-white">Tüm sayfaların banner <span class="font-bold">arkaplanlarını</span> <br>değiştirebilirsiniz</h3>
                                        <div>
                                            <a class="btn btn-dark b-0 waves-effect waves-light m-t-15 text-white" href="pages.php?sayfa=pageheaders">DETAYLAR</a>
                                        </div>
                                    </div>

                                    <div class="carousel-item flex-column">
                                        <i class="ti-menu text-white" style="font-size:24px"></i>
                                        <p class="text-white">Header Menü</p>
                                        <h3 class="text-white">Sitenizin üst menüsünü <span class="font-bold">kontrol</span> <br>edebilirsiniz</h3>
                                        <div>
                                            <a class="btn btn-dark b-0 waves-effect waves-light m-t-15 text-white" href="pages.php?sayfa=headermenu">DETAYLAR</a>
                                        </div>
                                    </div>

                                    <div class="carousel-item flex-column">
                                        <i class="ti-layout-slider text-white" style="font-size:24px"></i>
                                        <p class="text-white">Üst Slider</p>
                                        <h3 class="text-white">Sitenize dilediğiniz kadar <span class="font-bold">slider</span> <br>ekleyebilirsiniz</h3>
                                        <div>
                                            <a class="btn btn-dark b-0 waves-effect waves-light m-t-15 text-white" href="pages.php?sayfa=sliderlar">DETAYLAR</a>
                                        </div>
                                    </div>

                                    <div class="carousel-item flex-column">
                                        <i class="mdi mdi-account-switch text-white" style="font-size:24px"></i>
                                        <p class="text-white">Ekibimiz</p>
                                        <h3 class="text-white">Firmanızda çalışan <span class="font-bold">ekibinizi</span> <br>tanıtabilirsiniz</h3>
                                        <div>
                                            <a class="btn btn-dark b-0 waves-effect waves-light m-t-15 text-white" href="pages.php?sayfa=ekipler">DETAYLAR</a>
                                        </div>
                                    </div>

                                    <div class="carousel-item flex-column">
                                        <i class="icon-heart text-white" style="font-size:24px"></i>
                                        <p class="text-white"></p>
                                        <h3 class="text-white">Daha fazlası için sol taraftaki <span class="font-bold">menüyü</span> <br>kullanabilirsiniz</h3>
                                        <div>
                                            <a class="btn btn-dark b-0 waves-effect waves-light m-t-15 text-white" ><i class="fa fa-check"></i></a>
                                        </div>
                                    </div>
                    ...
                    <?php
                    $telsayisicek = $db ->prepare("select * from sms_numaralar");
                    $telsayisicek->execute();

                    $mailSayisicek = $db ->prepare("select * from ebulten");
                    $mailSayisicek->execute();

                    ?>



                    <a alt="default" href="pages.php?sayfa=toplusmsgonder" style="cursor: pointer">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="d-flex no-block align-items-center">
                                                <div>
                                                    <h3><i class="mdi mdi-cellphone-basic text-secondary"></i> <i class="icon-action-undo text-secondary"></i></h3>
                                                    <p class="text-secondary" ><?=$telsayisicek->rowCount()?> Kayıtlı Numara</p>
                                                </div>
                                                <div class="ml-auto">
                                                    <h4 class="counter text-secondary">TOPLU SMS GÖNDER</h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                    ...
                    <a alt="default" href="pages.php?sayfa=ebultengonder" style="cursor: pointer">
                        <div class="col-lg-12 col-md-12" style="padding-left: 0; padding-right: 0; " >
                            <div class="card" style=" background: linear-gradient(45deg, #212529, #666) !important;">
                                <div class="card-body" >
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="d-flex no-block align-items-center">
                                                <div>
                                                    <h3><i class="icon-envelope-open text-secondary"></i> <i class="icon-action-undo text-secondary"></i></h3>
                                                    <p class="text-secondary" ><?=$mailSayisicek->rowCount()?> Kayıtlı E-Posta</p>
                                                </div>
                                                <div class="ml-auto">
                                                    <h4 class="counter text-secondary">TOPLU E-POSTA GÖNDER</h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
